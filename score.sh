...
if ( $#argv != 3)   then
   echo "Usage: $0 [-NOFILT] [-CONFTREE tree] [-CTM ctm] srcdir testset pass"
   exit 1
endif
...
if ( $?NOFILTER ) then
    base/stools/scoremlf-nofilt $TYPE ${TYPE}_${FPASS} ${MLF} >& scoring/sclite/${TYPE}_${FPASS}.LOG   
else
